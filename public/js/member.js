...
async function loadMember() {
  ...
  document.getElementById('detailPhrase').textContent = m.phrase || m.signature || '这个人很神秘，还没有留下个人短语。';

  document.getElementById('cardNickname').textContent = m.nickname;
  document.getElementById('cardRole').textContent = m.roleTitle || m.role || '成员';
